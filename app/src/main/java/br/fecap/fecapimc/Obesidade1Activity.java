...
public class Obesidade1Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.obesidade1activity);
        ...
        pesoText = findViewById(R.id.pesoT6Text);
        alturaText = findViewById(R.id.alturaT6Text);
        IMCText = findViewById(R.id.imcT6Text);
