...
public class Obesidade2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.obesidade2activity);
        ...
        pesoText = findViewById(R.id.pesoT7Text);
        alturaText = findViewById(R.id.alturaT7Text);
        IMCText = findViewById(R.id.imcT7Text);
