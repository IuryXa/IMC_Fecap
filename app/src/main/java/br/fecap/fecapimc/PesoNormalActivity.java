...
public class PesoNormalActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.pesonormalactivity);
        ...
        pesoText = findViewById(R.id.pesoT4Text);
        alturaText = findViewById(R.id.alturaT4Text);
        IMCText = findViewById(R.id.imcT4Text);
